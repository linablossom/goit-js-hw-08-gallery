...
var activeImg = 0;
var imgLength = galleryItems.length - 1;
...
var galleryMarkup = createGalleryMarkupStr(galleryItems);
...
function createGalleryMarkupStr(images) {
  return images.map(function (_ref, index) {
    ...
    return "<li class=\"gallery__item\"><a class=\"gallery__link\" href=\"".concat(original, "\"><img class=\"gallery__image\" src=\"").concat(preview, "\" data-index=\"").concat(index, "\" data-source=\"").concat(original, "\" alt=\"").concat(description, "\"></a></li>");
  }).join("");
}
